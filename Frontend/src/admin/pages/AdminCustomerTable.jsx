...
const AdminCustomerTable = () => {
  ...
  const handleAPI = async () => {
    const response = await axios.get(
      "https://digitalkirana-server.vercel.app/admin/dashboard/allCustomers"
    );
              ...
              {localCustomers.map((customer, index) => {
                return (
                  <tr className="cus-data">
                    ...
                    <td className="cus-data-view">
                      <i className="bx bx-search-alt-2 view-cus-btn"></i>
                    </td>
                    <td className="cus-data-actions">
                      <i className="bx bx-trash-alt delete-cus-btn"></i>
                    </td>
                  </tr>
                );
              })}
