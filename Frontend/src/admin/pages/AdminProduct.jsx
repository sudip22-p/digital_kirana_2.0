...
const AdminProduct = () => {
  ...
  const handleAPI = async () => {
    const product = await axios.get(
      "https://digitalkirana-server.vercel.app/admin/dashboard/allProducts"
    );
      ...
      <main id="productListingPage">
        ...
        <section class="admin-product-search">
          <div class="admin-product-search-container">
            ...
            <select name="" id="" class="product-category-search">
              ss
            ...
            {products.map((product, index) => {
              return (
                <tr class="product-data" key={index}>
                  ...
                  <td class="prod-data-view">
                    <Link to="/adminProductDetail">
                      <box-icon name="search-alt-2"></box-icon>
                    </Link>
                  </td>
                  <td class="prod-data-actions">
                    <i class="bx bx-edit-alt edit-prod-btn"></i>
                    <i class="bx bx-trash-alt delete-prod-btn"></i>
                  </td>
                </tr>
              );
            })}
