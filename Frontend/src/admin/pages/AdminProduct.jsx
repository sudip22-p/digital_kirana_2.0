...
const AdminProduct = () => {
    ...
    const handleAPI = async () =>{
        const product = await axios.get('https://digitalkirana-server.vercel.app/admin/dashboard/allProducts')
        const category = await axios.get('https://digitalkirana-server.vercel.app/admin/dashboard/allCategories')
