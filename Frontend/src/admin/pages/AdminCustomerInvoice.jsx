      ...
      <main>
        ...
        <section id="invoiceContent">
          <div class="invoice-heading">
            <img
              src="https://digitalkirana-server.vercel.app/Assets/Images/Icons/logo_single.png"
              alt="Digital Kirana Logo"
            />
            <span>
              Order <span id="orderId">#123456</span>
            </span>
          </div>
          <hr />
          <div class="invoice-date-status">
            <p class="date-container">
              Date{" "}
              <span id="orderTime" class="order-date">
                2024-06-01
              </span>
            </p>
            <span>
              Status{" "}
              <span id="orderStatus" class="status Processing">
                Processing
              </span>
            </span>
          </div>
          <div class="customer-information">
            <div class="invoice-customer-details">
              ...
              <span id="customerName" class="customer-name">
                John Doe
              </span>
