...
const AdminCategory = () => {
  ...
  const handleAPI = async () => {
    const response = await axios.get(
      "https://digitalkirana-server.vercel.app/admin/dashboard/allCategories"
    );
        ...
        <main id="categoryListingPage">
          ...
          <section className="admin-category-search">
            <div className="admin-category-search-container">
              ...
              <select name="" id="" className="category-category-search">
                ss
            ...
            <button className="add-category-btn">
              <Link to="/adminCategory/addCategory">Add New category</Link>{" "}
              ...
              {categories.map((category, index) => {
                return (
                  <tr className="category-data">
                    ...
                    <td className="cat-data-view">
                      <i className="bx bx-search-alt-2 view-cat-btn"></i>
                    </td>
                    <td className="cat-data-actions">
                      <i className="bx bx-edit-alt edit-cat-btn"></i>
                      <i className="bx bx-trash-alt delete-cat-btn"></i>
                    </td>
                  </tr>
                );
              })}
