          ...
          <section className="full-order-page">
                ...
                {cart.cartItems.map((cartItem) => (
                  <div className="order-item-container">
                    ...
                    <div className="order-item-detail">
                      <h2 className="order-prod-name">
                        {cartItem.productName}
                      </h2>
                      <p className="order-prod-price">
                        Price : Rs <span> {cartItem.salesPrice}</span>
                      </p>
                      <div className="order-prod-qty">
                        <i className="bx bxs-minus-circle"></i>
                        <span className="order-prod-qty-value">
                    ...
                    <div className="order-item-final-container">
                      <span className="order-item-total-amt">
                        Rs {cartItem.salesPrice * cartItem.cartQuantity}
                      </span>
                    </div>
                  </div>
                ))}
            ...
            <section className="order-right-container">
              ...
              <div className="order-summary">
                ...
                <span className="value delivery">Rs 0</span>
                <span className="title total-payment">Total Payment</span>
