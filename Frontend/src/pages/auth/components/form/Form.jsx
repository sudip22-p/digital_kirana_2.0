...
const Form = ({ type, onSubmit }) => {
  ...
  const google = () => {
    window.open(
      "https://digitalkirana-server.vercel.app/auth/login/google",
      "_self"
    );
  };
  const facebook = () => {};
    ...
    <>
      <main id="signupContainer">
        <div className="container">
          {type === "Register" ? <h1>Sign Up</h1> : <h1>Welcome back, </h1>}
          ...
          <div className="extra-option">
            <span className="or-container">or continue with</span>
