  ...
  useEffect(() => {
    const handleAPI = async () => {
      const singleProduct = await axios.get(
        `https://digitalkirana-server.vercel.app/api/singlePage/${id}`
      );
              ...
              <figure className="detail-product-img-container">
                <div className="small-img-container">
                  <div className="img1 mini-img focus">
                    <img
                      src={`https://digitalkirana-server.vercel.app/Assets/Images/Products/${frontView}`}
                      alt=""
                    />
                  </div>
                  <div className="img2 mini-img">
                    <img
                      src={`https://digitalkirana-server.vercel.app/Assets/Images/Products/${backView}`}
                      alt=""
                    />
                  </div>
                  <div className="img3 mini-img">
                    <img
                      src={`https://digitalkirana-server.vercel.app/Assets/Images/Products/${sideView}`}
                      alt=""
                    />
                  </div>
                  <div className="img3 mini-img">
                    <img
                      src={`https://digitalkirana-server.vercel.app/Assets/Images/Products/${topView}`}
                      alt=""
                    />
                  </div>
                </div>
