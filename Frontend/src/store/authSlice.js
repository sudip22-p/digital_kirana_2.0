  ...
  return async function loginChunk(dispatch) {
    ...
    try {
      const response = await axios.post(
        "https://digitalkirana-server.vercel.app/auth/login",
        data
      );
...
export const register = (data) => {
  return async function registerChunk(dispatch) {
    ...
    try {
      const response = await axios.post(
        "https://digitalkirana-server.vercel.app/auth/register",
        data
      );
...
export const handleSuccessLogin = (data) => {
  return async (dispatch) => {
    const response = await axios.get(
      "https://digitalkirana-server.vercel.app/auth/login/success",
      {
        params: data,
      }
    );
...
export const getLogoutGoogle = () => {
  ...
  return async (dispatch) => {
    ...
    console.log("Logout");
    window.open(
      "https://digitalkirana-server.vercel.app/auth/google/logout",
      "_self"
    );
  };
};
